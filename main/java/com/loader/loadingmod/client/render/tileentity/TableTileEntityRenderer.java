package com.loader.loadingmod.client.render.tileentity;
...
public class TableTileEntityRenderer extends TileEntityRenderer<TableTileEntity>{
	private Minecraft mc = Minecraft.getInstance();

	public TableTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TableTileEntity te, float partialTicks, MatrixStack matrixStackIn,
		...
		renderItem(te.getItem(), new double[] { 0.5d, 1d, 0.5d },
				//player.rotationYaw
				Vector3f.YP.rotationDegrees(180f - player.yHeadRot), matrixStackIn, bufferIn, partialTicks,
